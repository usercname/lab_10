...
class MasterClassTest extends TestCase
{
    ...
    /** @test */
    public function master_class_has_instructor_relationship(): void
    {
    ...
    /** @test */
    public function master_class_has_type_relationship(): void
    {
        $masterClass = MasterClass::factory()->create([
    ...
    /** @test */
    public function master_class_has_bookings_relationship(): void
    {
        $masterClass = MasterClass::factory()->create([
            'max_participants' => 10,
        ]);
    ...
    /** @test */
    public function free_seats_calculated_correctly(): void
    {
        $masterClass = MasterClass::factory()->create([
            'max_participants' => 10,
        ]);
    ...
    /** @test */
    public function master_class_can_be_created(): void
    {
    ...
    /** @test */
    public function master_class_can_be_updated(): void
    {
        $masterClass = MasterClass::factory()->create();
    ...
    /** @test */
    public function master_class_can_be_deleted(): void
    {
        $masterClass = MasterClass::factory()->create();
        $masterClass->delete();
